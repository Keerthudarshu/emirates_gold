...
<body data-rsssl=1 class="home wp-singular page-template-default page page-id-2374 wp-embed-responsive wp-theme-hello-elementor wp-child-theme-muliya-jewels theme-hello-elementor woocommerce-no-js hello-elementor-default elementor-default elementor-kit-7 elementor-page elementor-page-2374">
  ...
  <?php include_once '../header.php'; ?>
    ...
    <h1 style="margin-top:100px;">Gold Mangalsutra</h1>
    ...
    <div class="product-list">
       <?php
        ...
        $count_sql = "SELECT COUNT(*) as total FROM gold_mangalsutra";
        ...
        $sql = "SELECT * FROM gold_mangalsutra LIMIT $items_per_page OFFSET $offset";
        $result = $conn->query($sql);

        if ($result && $result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                $productUrl = 'gold_mangalsutra_product.php?code=' . urlencode($row['code']) . '&type=gold_mangalsutra';
                echo '<div class="product-card">';
                echo '<a href="' . $productUrl . '">';
                $imgPath = !empty($row['image']) ? $row['image'] : 'img/gold_mangalsutra/default.jpg';
            ...
            echo "<p>No gold mangalsutra products found.</p>";
        }
        ?>
    </div>
