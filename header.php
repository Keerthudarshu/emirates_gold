<?php
// Define image paths as PHP variables - use dynamic base path for subdirectories
...
$gold_icon_path_2 = $base_path . "assets/favicon/gold.png";
$diamond_icon_path = $base_path . "assets/favicon/diamond.png";
$collections_icon_path = $base_path . "assets/favicon/collections.png";
$showroom_icon_path = $base_path . "assets/favicon/showroom.png";
$menu_icon_path = $base_path . "assets/favicon/menu.png";

// Gold menu images
$rings_menu_path = $base_path . "assets/gold_menu/Rings-Menu.png";
$earrings_menu_path = $base_path . "assets/gold_menu/Earrings-Menu.png";
$pendants_menu_path = $base_path . "assets/gold_menu/Pendants-menu-1.png";
$necklaces_menu_path = $base_path . "assets/gold_menu/Necklaces-Menu.png";
$haarams_menu_path = $base_path . "assets/gold_menu/Haarams.png";
$kadaas_menu_path = $base_path . "assets/gold_menu/Kadaas-menu.png";
$mangalsutra_menu_path = $base_path . "assets/gold_menu/Mangalsutra-menu.png";
$bangles_menu_path = $base_path . "assets/gold_menu/Bangles-Menu-1.png";
$chain_menu_path = $base_path . "assets/gold_menu/chain.png";
$bracelets_menu_path = $base_path . "assets/gold_menu/Bracelets.png";
$gold_mega_menu_path = $base_path . "assets/gold_menu/Gold-Mega-Menu.png";

// Diamond menu images
$diamond_rings_path = $base_path . "assets/diamond_menu/Rings-diamond.png";
$diamond_earrings_path = $base_path . "assets/diamond_menu/Earrings-diamond.png";
$diamond_pendants_path = $base_path . "assets/diamond_menu/Pendants-diamond.png";
$diamond_necklaces_path = $base_path . "assets/diamond_menu/Necklaces-diamond.png";
$diamond_bangles_path = $base_path . "assets/diamond_menu/Bangles-Diamond.png";
$diamond_bracelets_path = $base_path . "assets/diamond_menu/brace.png";
$diamond_mega_menu_path = $base_path . "assets/diamond_menu/Diamond-Mega-Menu.png";

// Homepage diamond collection images
$diamond_necklace_home_path = $base_path . "assets/diamond/diamond-necklace.jpg";
$diamond_ring_home_path = $base_path . "assets/diamond/diamond-ring.jpg";
$diamond_bangle_home_path = $base_path . "assets/diamond/diamond-bangle.jpg";
$diamond_earring_home_path = $base_path . "assets/diamond/diamond-earring.jpg";
$diamond_mangalsutra_home_path = $base_path . "assets/diamond/diamond-mangalsutra.jpg";

// Homepage occasion collection images
$occasion_rings_path = $base_path . "assets/occasion/Rings.png";
$occasion_haarams_path = $base_path . "assets/occasion/Home-Haarams.png";
$occasion_necklaces_path = $base_path . "assets/occasion/Necklaces.png";
$occasion_kadaas_path = $base_path . "assets/occasion/Kadaas.png";
$occasion_mangalsutra_path = $base_path . "assets/occasion/Mangalsutra.png";
$occasion_bangles_path = $base_path . "assets/occasion/Bangles.png";
$occasion_earrings_path = $base_path . "assets/occasion/Earrings.png";
$occasion_pendants_path = $base_path . "assets/occasion/Pendants.png";

// Experience section videos
$video_diamond1 = $base_path . "assets/video/diamond1.mp4";
$video_diamond_size = $base_path . "assets/video/diamond size.mp4";
$video_gold = $base_path . "assets/video/gold.mp4";
$video_diamond2 = $base_path . "assets/video/diamond2.mp4";

// Bridal collection images
$bridal_gold_image = $base_path . "assets/bridal/gold-bridal.jpg";
$bridal_diamond_image = $base_path . "assets/bridal/diamond-bridal.jpg";

// Bridal collection links
$bridal_gold_link = $base_path . "gold/bridal-gold.php";
$bridal_diamond_link = $base_path . "diamond/bridal-diamond.php";

// Gold collection page links
$gold_rings_link = $base_path . "gold/gold_ring.php";
$gold_haarams_link = $base_path . "gold/gold_haarams.php";
$gold_necklaces_link = $base_path . "gold/gold_necklaces.php";
$gold_kadaas_link = $base_path . "gold/gold_kadaas.php";
$gold_mangalsutra_link = $base_path . "gold/gold_mangalsutra.php";
$gold_bangles_link = $base_path . "gold/gold_bangles.php";
$gold_earrings_link = $base_path . "gold/gold_earrings.php";
$gold_pendants_link = $base_path . "gold/gold_pendants.php";
$gold_main_link = $base_path . "gold/gold.php";
$diamond_main_link = $base_path . "diamond/diamond.php";
?>
<!doctype html>
<html lang="en-US">
...
<head>
    ...
    <link rel="icon" href="<?php echo $logo_path; ?>" type="image/jpeg">
    
    <title> Emirates Gold &amp; Diamonds | Creating Happiness</title>
                        ...
                        <div class="elementor-element elementor-element-f7430de e-con-full e-flex e-con e-child" data-id="f7430de" data-element_type="container" >
                            ...
                            <div class="elementor-element elementor-element-07f9549 elementor-icon-list--layout-inline mj-gold-rate-btn elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-id="07f9549" data-element_type="widget" data-widget_type="icon-list.default">
                                <div class="elementor-widget-container">
                                   ...
                                   <img src="<?php echo $gold_icon_path; ?>" alt="Gold Bar Icon">
                                    ...
                                    <ul class="e-n-menu-heading">
                                        <li class="e-n-menu-item">
                                            <div id="e-n-menu-title-8201" class="e-n-menu-title">
                                                <a class="e-n-menu-title-container e-link" href="#">												
                                                    <span class="e-n-menu-title-text">
                                                        <img src="<?php echo $gold_icon_path_2; ?>" style="margin-right:6px; Width: 24px;" alt="Gold Icon">Gold						
                                                    </span>
                                                        
                                                </a> 
                                               
                                                <button id="e-n-menu-dropdown-icon-8201" class="e-n-menu-dropdown-icon" data-tab-index="1" aria-haspopup="true" aria-expanded="false" aria-controls="e-n-menu-content-8201">
                                                        <span class="e-n-menu-dropdown-icon-opened">
                                                            ...
                                                            <span class="elementor-screen-only">Close <img src="<?php echo $gold_icon_path_2; ?>" style="margin-right:6px; Width: 24px;" alt="Gold Icon">Gold</span>
                                                        </span>
                                                    ...
                                                    <div class="e-con-inner">
                                                        <div class="elementor-element elementor-element-3be9c34 e-con-full e-flex e-con e-child" data-id="3be9c34" data-element_type="container">
                                                            <div class="elementor-element elementor-element-60d05ab e-grid e-con-full e-con e-child" data-id="60d05ab" data-element_type="container">
                                                                <!-- Removed all muliya.in links from Gold mega menu -->
                                                                 <a class="elementor-element elementor-element-bd51c0f e-con-full mj-mm-item e-flex e-con e-child" data-id="bd51c0f" data-element_type="container" href="<?php echo $base_path; ?>gold/gold_ring.php"> 
                                                                ...
                                                                <a class="elementor-element elementor-element-752b421 e-con-full mj-mm-item e-flex e-con e-child" data-id="752b421" data-element_type="container" href="<?php echo $base_path; ?>gold/gold_earring.php">
                                                                ...
                                                                <a class="elementor-element elementor-element-e673ace e-con-full mj-mm-item e-flex e-con e-child" data-id="e673ace" data-element_type="container" href="<?php echo $base_path; ?>gold/gold_pendants.php">
                                                                ...
                                                                <a class="elementor-element elementor-element-6950440 e-con-full mj-mm-item e-flex e-con e-child" data-id="6950440" data-element_type="container" href="<?php echo $base_path; ?>gold/gold_necklaces.php">
                                                                    <div class="elementor-element elementor-element-f812653 e-con-full e-flex e-con e-child" data-id="f812653" data-element_type="container">
                                                                        <div class="elementor-element elementor-element-9120555 elementor-widget elementor-widget-image" data-id="9120555" data-element_type="widget" data-widget_type="image.default">
                                                                            <div class="elementor-widget-container">
                                                                            <img width="90" height="89" src="<?php echo $necklaces_menu_path; ?>" class="attachment-full size-full wp-image-11218" alt="Necklaces" /> </div>
                                                                                                                                               </div>
                                                                ...
                                                                <a class="elementor-element elementor-element-b8d5147 e-con-full mj-mm-item e-flex e-con e-child" data-id="b8d5147" data-element_type="container" href="<?php echo $base_path; ?>gold/gold_haarams.php">
                                                                ...
                                                                <a class="elementor-element elementor-element-fa9a6ad e-con-full mj-mm-item e-flex e-con e-child" data-id="fa9a6ad" data-element_type="container" href="<?php echo $base_path; ?>gold/gold_kadaas.php">
                                                                ...
                                                                <a class="elementor-element elementor-element-a34bdd2 e-con-full mj-mm-item e-flex e-con e-child" data-id="a34bdd2" data-element_type="container" href="<?php echo $base_path; ?>gold/gold_mangalsutra.php">
                                                                ...
                                                                <a class="elementor-element elementor-element-b4e325b e-con-full mj-mm-item e-flex e-con e-child" data-id="b4e325b" data-element_type="container" href="<?php echo $base_path; ?>gold/gold_bangles.php">
                                                                ...
                                                                <a class="elementor-element elementor-element-1749918 e-con-full mj-mm-item e-flex e-con e-child" data-id="1749918" data-element_type="container" href="<?php echo $base_path; ?>gold/gold_chain.php">
                                                                ...
                                                                <a class="elementor-element elementor-element-276a7bb e-con-full mj-mm-item e-flex e-con e-child" data-id="276a7bb" data-element_type="container" href="<?php echo $base_path; ?>gold/gold_bracelets.php">
                                                        ...
                                                        <div class="elementor-element elementor-element-c51ef47 e-con-full elementor-hidden-tablet elementor-hidden-mobile e-flex e-con e-child" data-id="c51ef47" data-element_type="container">
                                                            <div class="elementor-element elementor-element-1d338b3 elementor-widget elementor-widget-image" data-id="1d338b3" data-element_type="widget" data-widget_type="image.default">
                                                                <div class="elementor-widget-container">
                                                                    <img loading="lazy" width="699" height="465" src="<?php echo $gold_mega_menu_path; ?>" class="attachment-full size-full wp-image-11638" alt="Gold" /> </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <li class="e-n-menu-item">
                                            <div id="e-n-menu-title-8203" class="e-n-menu-title">
                                                <a class="e-n-menu-title-container e-link" href="<?php echo $base_path; ?>diamond/diamond.php">												<span class="e-n-menu-title-text">
                            <img src="<?php echo $diamond_icon_path; ?>" style="margin-right:6px; Width: 18px;">Diamond						</span>
                    </a> 
                    <button id="e-n-menu-dropdown-icon-8203" class="e-n-menu-dropdown-icon" data-tab-index="3" aria-haspopup="true" aria-expanded="false" aria-controls="e-n-menu-content-8203">
                            <span class="e-n-menu-dropdown-icon-opened">
                                                    ...
                                                    <div class="e-con-inner">
                                                        <div class="elementor-element elementor-element-c82ddff e-con-full e-flex e-con e-child" data-id="c82ddff" data-element_type="container">
                                                            <div class="elementor-element elementor-element-6767b61 e-grid e-con-full e-con e-child" data-id="6767b61" data-element_type="container">
                                                                <a class="elementor-element elementor-element-9530cf7 e-con-full mj-mm-item e-flex e-con e-child" data-id="9530cf7" data-element_type="container" href="<?php echo $base_path; ?>diamond/diamond_rings.php">
                                                                ...
                                                                <a class="elementor-element elementor-element-7a20ab7 e-con-full mj-mm-item e-flex e-con e-child" data-id="7a20ab7" data-element_type="container" href="<?php echo $base_path; ?>diamond/diamond_earring.php">
                                                                ...
                                                                <a class="elementor-element elementor-element-a4ef536 e-con-full mj-mm-item e-flex e-con e-child" data-id="a4ef536" data-element_type="container" href="<?php echo $base_path; ?>diamond/diamond_pendants.php">
                                                                ...
                                                                <a class="elementor-element elementor-element-d469b06 e-con-full mj-mm-item e-flex e-con e-child" data-id="d469b06" data-element_type="container" href="<?php echo $base_path; ?>diamond/diamond_necklaces.php">
                                                                ...
                                                                <a class="elementor-element elementor-element-0042de6 e-con-full mj-mm-item e-flex e-con e-child" data-id="0042de6" data-element_type="container" href="<?php echo $base_path; ?>diamond/diamond_bangles.php">
                                                                ...
                                                                <a class="elementor-element elementor-element-f819d33 e-con-full mj-mm-item e-flex e-con e-child" data-id="f819d33" data-element_type="container" href="<?php echo $base_path; ?>diamond/diamond_bracelets.php">
                                                        ...
                                                        <div class="elementor-element elementor-element-d489a82 e-con-full elementor-hidden-tablet elementor-hidden-mobile e-flex e-con e-child" data-id="d489a82" data-element_type="container">
                                                            <div class="elementor-element elementor-element-1aa5e6a elementor-widget elementor-widget-image" data-id="1aa5e6a" data-element_type="widget" data-widget_type="image.default">
                                                                <div class="elementor-widget-container">
                                                                    <img loading="lazy" width="647" height="465" src="<?php echo $diamond_mega_menu_path; ?>" class="attachment-full size-full wp-image-11637" alt="Diamond" /> </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <img src="<?php echo $collections_icon_path; ?>" style="margin-right:6px; Width: 18px;">Collections						</span>
                                                </div>
                                                 <button id="e-n-menu-dropdown-icon-8204" class="e-n-menu-dropdown-icon" data-tab-index="4" aria-haspopup="true" aria-expanded="false" aria-controls="e-n-menu-content-8204">
                            <span class="e-n-menu-dropdown-icon-opened">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6"><path stroke-linecap="round" stroke-linejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5"></path></svg>								<span class="elementor-screen-only">Close <img src="<?php echo $collections_icon_path; ?>" style="margin-right:6px; Width: 18px;">Collections</span>
                            </span>
                            <span class="e-n-menu-dropdown-icon-closed">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6"><path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5"></path></svg>								<span class="elementor-screen-only">Open <img src="<?php echo $collections_icon_path; ?>" style="margin-right:6px; Width: 18px;">Collections</span>
                            </span>
                        </button>
                                            </div>
                                            <div class="e-n-menu-content">
                                        ...
                                        <li class="e-n-menu-item">
                                            <div id="e-n-menu-title-8205" class="e-n-menu-title">
                                                <a class="e-n-menu-title-container e-link" href="">												<span class="e-n-menu-title-text">
                            <img src="<?php echo $showroom_icon_path; ?>" style="margin-right:6px; Width: 18px;">Showrooms						</span>
                    </a> </div>
                                        </li>
                                        ...
                                        <li class="e-n-menu-item">
                                            <div id="e-n-menu-title-8208" class="e-n-menu-title">
                                                <div class="e-n-menu-title-container"> <span class="e-n-menu-title-text">
                            <img src="<?php echo $menu_icon_path; ?>" style="margin-right:6px; Width: 18px;">More						</span>
                                                </div>
                                 <button id="e-n-menu-dropdown-icon-8208" class="e-n-menu-dropdown-icon" data-tab-index="8" aria-haspopup="true" aria-expanded="false" aria-controls="e-n-menu-content-8208">
                            <span class="e-n-menu-dropdown-icon-opened">
