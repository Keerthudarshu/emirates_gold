  ...
  if (btn && content) {
    ...
    <div class="product-list">
       <?php
        ...
        $count_sql = "SELECT COUNT(*) as total FROM diamond_pendants";
        ...
        if ($result && $result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                $imgPath = !empty($row['image']) ? $row['image'] : 'img/diamond_pendants/default.jpg';
            ...
            echo "<p>No diamond pendant products found.</p>";
        }
        ?>
    </div>
