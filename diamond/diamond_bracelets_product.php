  ...
  <?php include_once '../header.php'; ?>
    ...
    <div class="product-view-container">
        ...
        <div class="product-details">
            ...
            <a class="back-link box-btn" href="diamond_bracelets.php">&larr; Back to Products</a>
        </div>
    </div>
        ...
        <div class="enquiry-popup">
            ...
            <div class="popup-header">
                ...
                <div class="product-info">
                    <small>Enquiry for: <?php echo htmlspecialchars($row['name'] ?? 'Diamond Bracelets'); ?> - <?php echo htmlspecialchars($row['code'] ?? ''); ?></small>
                </div>
            </div>
