            ...
            class MegaMenu extends elementorModules.frontend.handlers.Base {
                ...
                activateTab(e) {
                    const t = this.getSettings(),
                        ...
                        a = this.elements.$tabContents.filter(this.getTabContentFilterSelector(e)).not(o);
                    this.addAnimationToContentIfNeeded(e), a[t.showTabFn](r, (() => this.onShowTabContent(a))), s.attr(this.getTitleActivationAttributes()), s.prev(".e-n-menu-title-container").find("a").attr(this.getTitleActivationAttributes("link")), a.addClass(n).parent().addClass(n), a.css({
                        display: "var(--display)"
                    }), a.removeAttr("display"), elementorFrontend.isEditMode() && a.length && this.activeContainerWidthListener(a), this.menuHeightController.reassignMenuHeight(a)
                }
                deactivateActiveTab() {
                    const e = this.getSettings(),
                        t = e.classes.active,
                ...
                onClickOutsideDropdownMenu(e) {
                    ...
                    l ? this.deactivateActiveTab() : s || a || r || this.deactivateActiveTab()
                }
                ...
                isCursorInBetweenMenuTitleAndContent(e) {
                    ...
                    const a = i.getBoundingClientRect(),
                        ...
                        d = e.clientY;
                    return a.bottom <= l.top ? d >= a.bottom && d < l.top : d <= a.top && d > l.bottom
                }
                ...
                updateIndexValues(e) {
                    ...
                    } = this.getDefaultSettings(), i = e[0], o = i.querySelectorAll(n), s = i.querySelectorAll(t), r = this.getSettings(), a = s[0].getAttribute("id").slice(0, -1);
                    s.forEach(((e, t) => {
                        const n = t + 1,
                            i = a + n,
                            s = i.replace("e-n-menu-title-", "e-n-menu-content-"),
                            l = i.replace("e-n-menu-title-", "e-n-menu-dropdown-icon-");
                        e.setAttribute("id", i), e.querySelector(r.selectors.tabDropdown) ? .setAttribute("data-tab-index", n), e.querySelector(r.selectors.tabDropdown) ? .setAttribute("id", l), e.querySelector(r.selectors.tabDropdown) ? .setAttribute("aria-controls", s), e.querySelector(r.selectors.tabTitleText) ? .setAttribute("data-binding-index", n), o[t] ? .setAttribute("aria-labelledby", l), o[t] ? .setAttribute("data-tab-index", n), o[t] ? .setAttribute("id", s)
                    }))
                }
                updateListeners(e) {
                    const {
                ...
                changeMegaMenuTitleContainerTag(e) {
                    const {
                        ...
                        actionName: n,
                        value: i
                    } = e.detail, o = t.parentNode, s = o.parentNode, r = this.maybeCreateNewElement(o, i), a = this.maybeReplaceMenuItemTitleContent(o, r, s), l = t.dataset ? .currentUrl || null;
                    this.maybeUpdateNewElementsHref(i, a), this.eCurrentClassHandler(n, s, l === i)
                }
