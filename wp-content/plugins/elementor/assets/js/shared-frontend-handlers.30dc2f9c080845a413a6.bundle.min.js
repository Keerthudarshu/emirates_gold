        ...
        628: (e, t, i) => {
            ...
            class BackgroundSlideshow extends elementorModules.frontend.handlers.SwiperBase {
                ...
                buildSwiperElements() {
                    ...
                    t.background_slideshow_gallery.forEach((imgObj => {
                        ...
                        if (r) {
                            ...
                            contentDiv = jQuery("<div>", {
                                class: d,
                                "data-background": imgObj.url
                            });
                            // Insert <img> for SEO and visibility
                            const imgTag = jQuery("<img>", {
                                src: imgObj.url,
                                alt: imgObj.alt || '',
                                style: 'width:100%;height:auto;display:block;'
                            });
                            contentDiv.append(imgTag);
                            contentDiv.append(preloader);
                        } else {
                            contentDiv = jQuery("<div>", {
                                class: d,
                                style: 'background-image: url("' + imgObj.url + '");'
                            });
                            // Insert <img> for SEO and visibility
                            const imgTag = jQuery("<img>", {
                                src: imgObj.url,
                        ...
                        slideDiv.append(contentDiv);
                        n.append(slideDiv);
                        this.elements.$slides = this.elements.$slides.add(slideDiv);
                    }));
                    o.append(n);
        ...
        3031: (e, t, i) => {
            ...
            class BackgroundVideo extends elementorModules.frontend.handlers.Base {
                ...
                prepareYTVideo(e, t) {
                    ...
                    const s = {
                        ...
                        events: {
                            ...
                            onStateChange: t => {
                                switch (t.data) {
                                    case n:
                                        i.removeClass(" elementor-loading");
                                        break;
                    ...
                    o.background_privacy_mode && (s.host = "https://www.youtube-nocookie.com", s.origin = window.location.hostname), i.addClass("elementor-loading "), this.player = new e.Player(this.elements.$backgroundVideoEmbed[0], s)
                }
                activate() {
